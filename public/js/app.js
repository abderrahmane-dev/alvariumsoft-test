...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    var page = new URL(location.href).searchParams.get("page") || 1;
    var url = "/employee/data?page=" + page;
    this.getEmployees(url);
  },
  methods: {
    getEmployees: function getEmployees(url) {
      var _this = this;
      ...
      var apiRequestUrl = url + "&per_page=" + this.per_page + "&department_slug=" + this.departmentSlug;
      this.current_url = apiRequestUrl;
      axios.get(apiRequestUrl).then(function (response) {
        _this.is_init_page_loading = false;

        if (response.data.employees.length > 0) {
          _this.is_empty = true["false"];
    ...
    paginate: function paginate(url, index) {
      if (url) {
    ...
    exportShowingData: function exportShowingData() {
    ...
    uploadXmlFile: function uploadXmlFile(event) {
      var _this2 = this;
      ...
      var apiRequestUrl = "/employee/import/xml";
      ...
      axios.post(apiRequestUrl, formData, {
        ...
        _this2.is_importing = false;
      });
    }
  },
  watch: {
    per_page: function per_page() {
      var url = "/employee/data?page=1";
      this.getEmployees(url);
    }
  }
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_employees_vue_vue_type_template_id_f37fc16c___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_employees_vue_vue_type_template_id_f37fc16c___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_employees_vue_vue_type_template_id_f37fc16c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./employees.vue?vue&type=template&id=f37fc16c& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/employees.vue?vue&type=template&id=f37fc16c&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/employees.vue?vue&type=template&id=f37fc16c&":
/*!*********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/employees.vue?vue&type=template&id=f37fc16c& ***!
  \*********************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  return _c("div", [
    _c(
      ...
      {
        staticClass:
          "flex w-full items-center md:flex-row flex-col justify-between space-x-0 space-y-2 md:space-y-0 md:space-x-3 p-3 bg-gray-100 rounded-md"
      },
      [
        _c(
          "div",
          { class: _vm.is_importing ? "opacity-50 w-full" : "w-full" },
          [
            _c(
              "label",
              {
                staticClass:
                  "relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 ",
                attrs: { for: "xml-upload" }
              },
              [
                _c(
                  "span",
                  {
                    staticClass:
                      "w-full md:w-1/3 xl:w-2/5 inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700"
                  },
                  [
                    _c("span", {
                      staticClass: "mx-auto",
                      domProps: {
                        textContent: _vm._s(
                          _vm.is_importing == true ? "Importing..." : "Import"
                        )
                      }
                    })
                  ]
        ...
        _c(
          ...
          {
            staticClass:
              "flex w-full md:w-2/3 xl:w-3/5 text-center items-center justify-center md:flex-row flex-col space-x-0 space-y-2 md:space-y-0 md:space-x-2"
          },
          [
            _c(
              "button",
              {
                ...
                attrs: { disabled: _vm.employees.length == 0, type: "button" },
                on: {
                  click: function($event) {
                    return _vm.exportShowingData()
                  }
                }
              },
              [
                _c("span", { staticClass: "mx-auto" }, [
                  _vm._v("Export Showing")
                ])
              ]
            ),
            _vm._v(" "),
            _c(
              "button",
              {
                ...
                on: {
                  click: function($event) {
                    return _vm.exportAllData()
                  }
                }
              },
              [_c("span", { staticClass: "mx-auto" }, [_vm._v("Export All")])]
            )
          ]
        )
      ]
    ...
    _vm.employees.length > 0
      ? _c("div", [
                                ...
                                return _c(
                                  ...
                                  [
                                    ...
                                    _c("td", {
                                      ...
                                      attrs: { nowrap: "" },
                                      domProps: {
                                        textContent: _vm._s(employee.birthdate)
                                      }
                                    }),
                                    _vm._v(" "),
                                    _c("td", {
                                      ...
                                      attrs: { nowrap: "" },
                                      domProps: {
                                        textContent: _vm._s(employee.position)
                                      }
                                    }),
                                    _vm._v(" "),
                                    _c("td", {
                                      ...
                                      attrs: { nowrap: "" },
                                      domProps: {
                                        textContent: _vm._s(employee.pay_type)
                                      }
                                    }),
                                    _vm._v(" "),
                                    _c("td", {
                                      ...
                                      attrs: { nowrap: "" },
                                      domProps: {
                                        textContent: _vm._s(employee.salary)
                                      }
                                    }),
                                    _vm._v(" "),
                                    _c(
          ...
          _c(
            ...
            {
              staticClass:
                "bg-white py-3 flex items-center justify-between border-t border-gray-200"
            },
            [
              _c(
                "div",
                ...
                [
                  _c("div", { staticClass: "mb-2 sm:mb-0" }, [
                    _c("div", [
                      _c(
                        "select",
                        {
                          ...
                          "button",
                          {
                            ...
                            class: {
                              ...
                              "bg-white border-gray-300 text-gray-500 hover:bg-gray-50":
                                link.active != true,
                              "relative inline-flex items-center px-2 py-2 rounded-sm border text-sm font-medium": true,
                              "cursor-not-allowed opacity-50": link.url == null
                            },
                            on: {
                              click: function($event) {
                                return _vm.paginate(link.url, index)
                              }
                            }
                          },
                          [
                            link.hasOwnProperty("is_loading")
                              ? _c("span", [
                                  _c(
                                    "svg",
                                    {
                                      staticClass:
                                        "animate-spin h-3 w-3 text-black mx-auto",
                                      attrs: {
      ...
      ? _c(
          "div",
          { staticClass: "flex flex-col items-center justify-center mt-12" },
          [
            _c(
              "svg",
              {
                staticClass: "h-40 w-40 text-gray-200",
                attrs: {
                  xmlns: "http://www.w3.org/2000/svg",
                  fill: "none",
                  viewBox: "0 0 24 24",
            ...
            _vm._v(" "),
            _c("span", { staticClass: "text-md font-thin text-gray-700" }, [
              _vm._v("Oops, There is no employees!")
            ])
          ]
        )
      : _c("div", { staticClass: "mx-auto mt-40" }, [
          _c(
            "svg",
            {
              staticClass: "animate-spin h-5 w-5 text-black mx-auto",
              attrs: {
                xmlns: "http://www.w3.org/2000/svg",
                fill: "none",
                viewBox: "0 0 24 24"
